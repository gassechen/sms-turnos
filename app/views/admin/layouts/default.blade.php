            ...
            <div class="container">
    			...
    			<div class="collapse navbar-collapse navbar-ex1-collapse">
    				<ul class="nav navbar-nav">
    					...
    					<li{{ (Request::is('admin/equips*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/equips') }}}"><span class="glyphicon glyphicon-list-alt"></span> Equipos</a></li>
    					<li{{ (Request::is('admin/comments*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/equips') }}}"><span class="glyphicon glyphicon-bullhorn"></span> Comments</a></li>
