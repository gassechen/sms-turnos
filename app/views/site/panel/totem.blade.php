          ...
          <div class="col-lg-4">
              ...
              <div class="panel-body">
                <div class="table-responsive">
                  ...
                  <tr>
              	    	<td>Promedio Presion Head:<b>{{$promediops}} PSI</b> </td>

                        <td>Promedio Presion Linea: <b>{{$promediodisc}} PSI</b></td>
            ...
            <div class="panel panel-primary">
              ...
              <div class="panel-body">
                ...
                <div class="text-right">
                  <a href="{{ URL::to('totemlist') }}">Ver Lista de equipos <i class="fa fa-arrow-circle-right"></i></a>
                </div>
              </div>
            </div>
          </div>
                  ...
                  <table id="totem" class="table table-bordered table-hover table-striped tablesorter">
                    <thead>
                      ...
                      <tr>
                        ...
                        <th>Presion Head<i class="fa fa-sort"></i></th>
                        <th>Presion Linea <i class="fa fa-sort"></i></th>
